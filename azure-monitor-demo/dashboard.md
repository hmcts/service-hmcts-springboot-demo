...
![Step 1 — Run a KQL query in Log Analytics](QueryErrors1.png)
...
![Step 2 — Add render columnchart to produce a chart](QueryErrorChart2.png)
...
![Step 3 — Save → Pin to Azure dashboard](QueryPinToDashboard3.png)
...
![Step 4 — Pin to dashboard dialog, Create new tab](PinToDashboard4.png)
...
![Step 5 — Dashboard link in the Azure Portal left nav](HomeDashboardLink5.png)
...
![Step 6 — Dashboard name dropdown showing available dashboards](DashboardList6.png)
...
![Step 7 — ColinsDashboard showing a pinned chart tile](ColinsDashboard7.png)
...
![Step 8 — Edit mode showing tiles that can be moved and resized](EditDashboard8.png)
...
![Export — Export → Download to get the dashboard JSON](DashboardExport9.png)
...
![Dashboard JSON structure in VS Code](DashboardJson10.png)
